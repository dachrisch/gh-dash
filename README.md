...
<table border="0" width="100%">
  ...
  <tr>
    <td width="50%" align="left" valign="top" style="border: 1px solid #30363d; border-radius: 6px; padding: 12px;">
      ...
      <div style="margin-top: 10px;">
        ...
        <a href="https://github.com/dachrisch/leaguesphere/releases"><img src="https://img.shields.io/badge/release-v4.12.0-blue?style=flat-square" alt="release"></a> <img src="https://img.shields.io/badge/22m-gray?style=flat-square" alt="release-age">
      </div>
    </td>
    <td width="50%" align="left" valign="top" style="border: 1px solid #30363d; border-radius: 6px; padding: 12px;">
  ...
  <tr>
    <td width="50%" align="left" valign="top" style="border: 1px solid #30363d; border-radius: 6px; padding: 12px;">
      ...
      <div style="margin-top: 10px;">
        <a href="https://github.com/dachrisch/sproutlings/commits/master"><img src="https://img.shields.io/badge/commit-54m-green?style=flat-square" alt="commit"></a> ˙ <a href="https://github.com/dachrisch/sproutlings/pulls"><img src="https://img.shields.io/github/issues-pr/dachrisch/sproutlings?label=prs&style=flat-square" alt="prs"></a> <img src="https://img.shields.io/badge/55m-gray?style=flat-square" alt="pr-age"><br>
        <a href="https://github.com/dachrisch/sproutlings/releases"><img src="https://img.shields.io/badge/release-v1.4.2-blue?style=flat-square" alt="release"></a> <img src="https://img.shields.io/badge/54m-gray?style=flat-square" alt="release-age">
      </div>
    </td>
    <td width="50%" align="left" valign="top" style="border: 1px solid #30363d; border-radius: 6px; padding: 12px;">
      ...
      <div style="margin-top: 10px;">
        ...
        <a href="https://github.com/dachrisch/ai-job-search/releases"><img src="https://img.shields.io/badge/release-v0.8.16-blue?style=flat-square" alt="release"></a> <img src="https://img.shields.io/badge/11h-gray?style=flat-square" alt="release-age">
      </div>
    </td>
  </tr>
  <tr>
    <td width="50%" align="left" valign="top" style="border: 1px solid #30363d; border-radius: 6px; padding: 12px;">
      ...
      <div style="margin-top: 10px;">
        ...
        <a href="https://github.com/dachrisch/league.finance/releases"><img src="https://img.shields.io/badge/release-v0.6.38-blue?style=flat-square" alt="release"></a> <img src="https://img.shields.io/badge/11h-gray?style=flat-square" alt="release-age">
      </div>
    </td>
    <td width="50%" align="left" valign="top" style="border: 1px solid #30363d; border-radius: 6px; padding: 12px;">
