...
<table border="0" width="100%">
  ...
  <tr>
    <td width="50%" align="left" valign="top" style="border: 1px solid #30363d; border-radius: 6px; padding: 12px;">
      ...
      <hr style="border: 0; border-top: 1px solid #30363d; margin: 8px 0;">
      <p style="margin: 12px 0;">
        <a href="https://circleci.com/workflow-run/e2395d4a-c563-42b4-8d48-e35894b7d439">
      ...
      <div style="margin-top: 10px;">
        ...
        <a href="https://github.com/dachrisch/leaguesphere/releases"><img src="https://img.shields.io/badge/release-v4.12.4-blue?style=flat-square" alt="release"></a> <img src="https://img.shields.io/badge/25m-gray?style=flat-square" alt="release-age">
      </div>
    </td>
    <td width="50%" align="left" valign="top" style="border: 1px solid #30363d; border-radius: 6px; padding: 12px;">
      ...
      <div style="margin-top: 10px;">
        ...
        <a href="https://github.com/dachrisch/league.finance/releases"><img src="https://img.shields.io/badge/release-v0.6.46-blue?style=flat-square" alt="release"></a> <img src="https://img.shields.io/badge/4h-gray?style=flat-square" alt="release-age">
      </div>
    </td>
  </tr>
  <tr>
    <td width="50%" align="left" valign="top" style="border: 1px solid #30363d; border-radius: 6px; padding: 12px;">
      ...
      <div style="margin-top: 10px;">
        ...
        <a href="https://github.com/dachrisch/groceries-order-tracking/releases"><img src="https://img.shields.io/badge/release-v1.9.69-blue?style=flat-square" alt="release"></a> <img src="https://img.shields.io/badge/12h-gray?style=flat-square" alt="release-age">
      </div>
    </td>
    <td width="50%" align="left" valign="top" style="border: 1px solid #30363d; border-radius: 6px; padding: 12px;">
      ...
      <div style="margin-top: 10px;">
        ...
        <a href="https://github.com/dachrisch/energy.consumption/releases"><img src="https://img.shields.io/badge/release-v3.16.67-blue?style=flat-square" alt="release"></a> <img src="https://img.shields.io/badge/1d-gray?style=flat-square" alt="release-age">
      </div>
    </td>
  </tr>
  <tr>
    <td width="50%" align="left" valign="top" style="border: 1px solid #30363d; border-radius: 6px; padding: 12px;">
      ...
      <div style="margin-top: 10px;">
        ...
        <a href="https://github.com/dachrisch/ai-job-search/releases"><img src="https://img.shields.io/badge/release-v0.8.18-blue?style=flat-square" alt="release"></a> <img src="https://img.shields.io/badge/1d-gray?style=flat-square" alt="release-age">
      </div>
    </td>
    <td width="50%" align="left" valign="top" style="border: 1px solid #30363d; border-radius: 6px; padding: 12px;">
