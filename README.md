...
<table border="0" width="100%">
  ...
  <tr>
    <td width="50%" align="left" valign="top" style="border: 1px solid #30363d; border-radius: 6px; padding: 12px;">
      ...
      <hr style="border: 0; border-top: 1px solid #30363d; margin: 8px 0;">
      <p style="margin: 12px 0;">
        <a href="https://circleci.com/gh/dachrisch/leaguesphere/50247">
          <img src="https://img.shields.io/badge/ACTION-FIX create_production_release-red?style=for-the-badge" alt="action">
        </a>
      </p>
      <div style="margin-top: 10px;">
        ...
        <a href="https://github.com/dachrisch/leaguesphere/releases"><img src="https://img.shields.io/badge/release-v4.6.5-blue?style=flat-square" alt="release"></a> <img src="https://img.shields.io/badge/4h-gray?style=flat-square" alt="release-age">
      </div>
    </td>
    <td width="50%" align="left" valign="top" style="border: 1px solid #30363d; border-radius: 6px; padding: 12px;">
      ...
      <div style="margin-top: 10px;">
        ...
        <a href="https://github.com/dachrisch/league.finance/releases"><img src="https://img.shields.io/badge/release-v0.6.27-blue?style=flat-square" alt="release"></a> <img src="https://img.shields.io/badge/5h-gray?style=flat-square" alt="release-age">
      </div>
    </td>
  </tr>
  <tr>
    <td width="50%" align="left" valign="top" style="border: 1px solid #30363d; border-radius: 6px; padding: 12px;">
      ...
      <div style="margin-top: 10px;">
        ...
        <a href="https://github.com/dachrisch/groceries-order-tracking/releases"><img src="https://img.shields.io/badge/release-v1.9.59-blue?style=flat-square" alt="release"></a> <img src="https://img.shields.io/badge/9h-gray?style=flat-square" alt="release-age">
      </div>
    </td>
    <td width="50%" align="left" valign="top" style="border: 1px solid #30363d; border-radius: 6px; padding: 12px;">
      ...
      <div style="margin-top: 10px;">
        ...
        <a href="https://github.com/dachrisch/energy.consumption/releases"><img src="https://img.shields.io/badge/release-v3.16.59-blue?style=flat-square" alt="release"></a> <img src="https://img.shields.io/badge/11h-gray?style=flat-square" alt="release-age">
      </div>
    </td>
  </tr>
  <tr>
    <td width="50%" align="left" valign="top" style="border: 1px solid #30363d; border-radius: 6px; padding: 12px;">
      ...
      <div style="margin-top: 10px;">
        ...
        <a href="https://github.com/dachrisch/ai-job-search/releases"><img src="https://img.shields.io/badge/release-v0.8.13-blue?style=flat-square" alt="release"></a> <img src="https://img.shields.io/badge/3d-gray?style=flat-square" alt="release-age">
      </div>
    </td>
    <td width="50%" align="left" valign="top" style="border: 1px solid #30363d; border-radius: 6px; padding: 12px;">
